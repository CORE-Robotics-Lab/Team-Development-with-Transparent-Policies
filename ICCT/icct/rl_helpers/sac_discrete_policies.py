# Created by Yaru Niu
# Revised from https://github.com/DLR-RM/stable-baselines3/blob/master/stable_baselines3/sac/policies.py
...
class Critic(BaseModel):
    ...
    def __init__(
        ...
        for idx in range(n_critics):
            q_net = create_mlp(features_dim, action_space.n, net_arch, activation_fn)
...
class Actor(BasePolicy):
    ...
    def get_action_dist_params(self, obs: th.Tensor) -> Tuple[th.Tensor, th.Tensor, Dict[str, th.Tensor]]:
        ...
        self.processed_obs = features
        self.raw_act = mean_actions
    ...
    def get_sa_pair(self):
        """
        Get real-time state and action pairs
        """
        return [self.processed_obs, self.raw_act]
...
class SACDiscretePolicy(BasePolicy):
    ...
    def __init__(
        ...
        super(SACDiscretePolicy, self).__init__(
            observation_space,
            action_space,
    ...
    def _build(self, lr_schedule: Schedule) -> None:
        ...
        if hasattr(self.actor, 'ddt'):
            self.actor.optimizer = self.optimizer_class(self.actor.parameters(), lr=self.actor.ddt_kwargs['ddt_lr'],
...
register_policy("MlpPolicy", SACDiscretePolicy)
