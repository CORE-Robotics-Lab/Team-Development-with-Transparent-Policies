# Created by Yaru Niu
# Revised from https://github.com/DLR-RM/stable-baselines3/blob/master/stable_baselines3/td3/td3.py
...
from ICCT.icct.rl_helpers.td3_policies import TD3Policy
        ...
        for _ in range(gradient_steps):
            ...
            if self._n_updates % self.policy_delay == 0:
                ...
                if hasattr(self.actor, 'ddt'):
                    if self.actor.ddt.use_submodels and self.actor.ddt.sparse_submodel_type == 1:
