...
import os
sys.path.insert(0, '../')
from ProLoNets.agents.idct_agent import IDCT_Agent
# from agents.non_deep_prolonet_agent import ProLoLoki
# from agents.random_prolonet_agent import RandomProLoNet
from ProLoNets.agents.heuristic_agent import LunarHeuristic, CartPoleHeuristic, RandomHeuristic
from ProLoNets.agents.lstm_agent import LSTMNet
from ProLoNets.agents.baseline_agent import FCNet
import random
from ProLoNets.opt_helpers.replay_buffer import discount_reward
