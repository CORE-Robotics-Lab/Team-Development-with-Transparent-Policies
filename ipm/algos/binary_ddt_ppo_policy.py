...
from stable_baselines3.common.policies import ActorCriticPolicy, register_policy, create_sde_features_extractor
from ipm.models.binary_idct import BinaryIDCT as IDCT
from torch.distributions import Categorical


class BinaryDDT_PPOPolicy(ActorCriticPolicy):
    """
    ...
    def __init__(
        ...
        super(BinaryDDT_PPOPolicy, self).__init__(
...
register_policy("BinaryDDT_PPOPolicy", BinaryDDT_PPOPolicy)