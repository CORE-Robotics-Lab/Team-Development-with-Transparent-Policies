...
~/PycharmProjects/PantheonRL/venv/bin/python3.7 /home/rohanpaleja/PycharmProjects/PantheonRL/trainer.py OvercookedMultiEnv-v0 PPO PPO --seed 4000 --preset 1 --verbose --remove_intent_model --high_level_action --high_level_state --domain 2 --use_idct --saving-name robot_policy_optimization_1 --load_rohan --ego_load '/home/rohanpaleja/PycharmProjects/ipm/ipm/bin/pre_robot_update.tar' --alt_load '/home/rohanpaleja/PycharmProjects/ipm/ipm/bin/pre_robot_update.tar' --total-timesteps 28000 &
