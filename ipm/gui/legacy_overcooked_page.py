...
class OvercookedGameDemo:
    def __init__(self, screen=None, other_agent=None,
                 ...
                 SCREEN_WIDTH=1800, SCREEN_HEIGHT=800,
    ...
    def run_static_resizeable_window(self, surface, fps=30):
        """
        ...
        # pygame.display.flip()
        window = pygame.display.set_mode(
            size=(self.SCREEN_WIDTH, self.SCREEN_HEIGHT), flags=HWSURFACE | DOUBLEBUF | RESIZABLE
        )
        window.blit(
            pygame.transform.scale(surface, (self.SCREEN_WIDTH, self.SCREEN_HEIGHT)), (0, 0)
        )
        ...
        while not self.horizon_env.is_done():
            ...
            while action_not_taken and not done:
                ...
                if self.visualizer is None:
                    ...
                    self.run_static_resizeable_window(state_visualized_surf)
                pygame.display.flip()
                clock.tick(60)
